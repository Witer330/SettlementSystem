...
async function main() {
  ...
  const products = [
    ...
    { name: '移动工作台', code: 'PROD002', category: '工位器具', unit: '台', price: 1500 },
    { name: '焊接支架', code: 'PROD003', category: '支撑结构', unit: '个', price: 350 },
    { name: '输送辊道', code: 'PROD004', category: '输送设备', unit: '米', price: 800 },
    { name: '防护围栏', code: 'PROD005', category: '安全防护', unit: '套', price: 1200 },
    { name: '工具柜', code: 'PROD006', category: '工位器具', unit: '台', price: 2200 },
    { name: '物料架', code: 'PROD007', category: '仓储设备', unit: '套', price: 1800 },
    { name: '钢结构平台', code: 'PROD008', category: '钢结构', unit: '套', price: 9500 },
  ]
