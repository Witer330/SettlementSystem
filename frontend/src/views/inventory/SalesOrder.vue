  ...
  <div class="page-container">
    <div class="page-header">
      ...
      <div class="page-header-actions">
        ...
        <el-button type="primary" @click="openDialog()"><el-icon><Plus /></el-icon>新增销售单</el-button>
      </div>
    </div>
    ...
    <SalesOrderForm v-model="dialogVisible" :is-edit="isEdit" :edit-id="editId" :row="currentRow" :customers="customers" :products="products" @success="onFormSuccess" />
...
// ── 表单 ──
function openDialog(row?: SalesOrder) { currentRow.value = row || null; isEdit.value = !!row && row.status !== 'draft'; editId.value = row?.id || 0; dialogVisible.value = true }
